//
//  CompletedDetailsTableViewCell.swift
//  Almonaseq
//
...
protocol CompletedDetailsTableViewCellDelegate{
    func rateTech()
}

class CompletedDetailsTableViewCell: UITableViewCell {
    ...
    var address = ""
    var delegate :CompletedDetailsTableViewCellDelegate?
