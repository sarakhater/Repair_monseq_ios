...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HWSwiftyViewPager/HWSwiftyViewPager.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/KVSpinnerView/KVSpinnerView.framework"
